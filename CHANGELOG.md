...
- Support nvidia-libs layout variants by @nikarh
...
- Release v0.0.13 (#40) by @nikarh-release-bot[bot] in #40
- Bump actions/upload-artifact from 6 to 7 (#41) by @dependabot[bot] in #41
- Pin rust toolchain by @nikarh
- Install clippy component by @nikarh
- Bump actions/create-github-app-token from 2 to 3 (#42) by @dependabot[bot] in #42

#### Fixed
- Fixed build by @nikarh
- Clippy by @nikarh
- Failing test by @nikarh
- Update rust dependencies by @nikarh
- Restore release workflow trigger by @nikarh
